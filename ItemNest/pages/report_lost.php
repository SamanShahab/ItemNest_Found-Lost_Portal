...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $message = $ok ? "Lost item reported successfully!" : "Error reporting item.";
}
...
<div class="report-form-container">
  <!-- Report Header -->
  <div class="report-header lost-report">
    <h2>🔍 Report Lost Item</h2>
    <p>Help us find your lost item by providing detailed information below. The more details you provide, the better chance we have of finding it!</p>
  </div>
  ...
  <?php if($message && strpos($message, 'successfully') !== false): ?>
    <div class="form-success">
      ...
      <p>Your lost item has been reported successfully. We'll notify you if anyone finds it.</p>
      <a href="dashboard.php" class="btn">View Dashboard</a>
    </div>
  <?php endif; ?>

  <!-- Report Form -->
  <form method="POST" enctype="multipart/form-data" class="report-form lost-form">
    ...
    <div class="form-section">
      <div class="section-header">
        ...
        <div>
          ...
          <p class="section-description">Tell us about the item you lost</p>
        </div>
      </div>
    ...
    <div class="form-section">
      <div class="section-header">
        ...
        <div>
          ...
          <p class="section-description">Where and when did you lose the item?</p>
        </div>
      </div>
    ...
    <div class="form-section">
      ...
      <div class="form-group">
        ...
        <textarea name="description" class="form-control" 
                  placeholder="Describe the item in detail (color, brand, unique features, contents, distinguishing marks...)" 
    ...
    <div class="help-text">
      ...
      <p>• Provide specific details about color, brand, and unique features<br>
         • Mention any identifying marks or serial numbers<br>
         • Upload clear photos from different angles<br>
         • Be precise about the location and time</p>
    </div>
